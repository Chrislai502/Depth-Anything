...
python3 train_mix_infer.py -d art --epochs 25 --w_mae 1.0 --w_si 0.0 --w_seg_si 0.0 --checkpoint "./depth_anything_finetune/DepthAnythingv1_27-Nov_21-04-28fd8f7d97fe_best.pt"