...
output_path = f"./{dataset_type}_{train_eval}_{track}_{bag}_dense_filenames.txt"
with open(output_path, "w") as f:
    ...
    for i, image_path in enumerate(tqdm(image_paths, desc="Processing images")):
        ...
        f.write(f"{bag}/image/{os.path.basename(image_path)} {bag}/groundtruth_dense/{os.path.basename(image_path)} {avg_focal:.4f}\n")
